...
// AvailableReactionsUpdate Request Data message
impl DataGetter<proto_chat::ChatGroupUpdateAvailableReactionsRequest>
    for proto_distro::ChatGroupAvailableReactionsUpdate
{
...
// AvailableReactionsUpdate Request Headers
impl HeaderGetter for proto_distro::ChatGroupAvailableReactionsUpdate {
...
impl
    NatsRequestSetter<
        ...
        proto_distro::ChatGroupAvailableReactionsUpdate,
    > for proto_distro::ChatGroupAvailableReactionsUpdate
{
