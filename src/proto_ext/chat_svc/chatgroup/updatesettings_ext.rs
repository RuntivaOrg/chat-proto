...
// ***********************************  Request Getters ***********************************
// UpdateSettings Request Data message
impl DataGetter<proto_chat::ChatGroupUpdateSettingsRequest>
    for proto_nats::NatsChatGroupUpdateSettingsRequest
{
...
// UpdateSettings Request Headers
impl HeaderGetter for proto_nats::NatsChatGroupUpdateSettingsRequest {
...
impl
    NatsRequestSetter<
        ...
        proto_nats::NatsChatGroupUpdateSettingsRequest,
    > for proto_nats::NatsChatGroupUpdateSettingsRequest
{
