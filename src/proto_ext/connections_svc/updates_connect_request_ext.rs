...
impl DataGetter<proto_connections::UpdatesConnection>
    for proto_connections::NatsUpdatesConnectRequest
{
...
impl HeaderGetter for proto_connections::NatsUpdatesConnectRequest {
...
impl
    NatsRequestSetter<
        ...
        proto_connections::NatsUpdatesConnectRequest,
    > for proto_connections::NatsUpdatesConnectRequest
{
