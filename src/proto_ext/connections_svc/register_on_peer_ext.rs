...
impl DataGetter<proto_connections::ConnectionPeer>
    for proto_connections::NatsRegisterOnPeerRequest
{
...
impl HeaderGetter for proto_connections::NatsRegisterOnPeerRequest {
...
impl
    NatsRequestSetter<
        ...
        proto_connections::NatsRegisterOnPeerRequest,
    > for proto_connections::NatsRegisterOnPeerRequest
{
